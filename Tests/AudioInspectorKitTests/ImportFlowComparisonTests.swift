...
struct ImportFlowComparisonTests {
    ...
    func startingAComparisonPreservesTheReport() async {
        ...
        primaryAction.finish(.inspected(primary, analyses: InspectionAnalyses(waveform: .unavailable, spectrogram: .unavailable, signalLevelMetrics: .unavailable, truePeak: .unavailable, loudness: .unavailable)))
        await running.value
    }
    ...
    func theComparisonAppearsWithTheSecondReport() async {
        ...
        second.finish(.inspected(other, analyses: InspectionAnalyses(waveform: .unavailable, spectrogram: .unavailable, signalLevelMetrics: .unavailable, truePeak: .unavailable, loudness: .unavailable)))
        await comparing.value
        primaryAction.finish(.inspected(primary, analyses: InspectionAnalyses(waveform: .unavailable, spectrogram: .unavailable, signalLevelMetrics: .unavailable, truePeak: .unavailable, loudness: .unavailable)))
        await running.value
    }
    ...
    func theSecondFilesVisualisationsChangeNothing() async {
        ...
        second.finish(
            ...
            .inspected(other, analyses: InspectionAnalyses(waveform: .unavailable, spectrogram: .failed(message: "no"), signalLevelMetrics: .unavailable, truePeak: .unavailable, loudness: .unavailable))
        )
        await comparing.value
    ...
    func cancellingAReplacementRestoresTheExistingComparison() async {
        ...
        await second.waitUntilStarted()
        second.finish(.inspected(b, analyses: InspectionAnalyses(waveform: .unavailable, spectrogram: .unavailable, signalLevelMetrics: .unavailable, truePeak: .unavailable, loudness: .unavailable)))
        await first.value
    ...
    func aGloballyFailedSecondFileStillCompares() async {
        ...
        let comparing = Task { await flow.compare(using: second.run) }
        await second.waitUntilStarted()
        second.finish(.inspected(broken, analyses: InspectionAnalyses(waveform: .unavailable, spectrogram: .unavailable, signalLevelMetrics: .unavailable, truePeak: .unavailable, loudness: .unavailable)))
        await comparing.value
    ...
    func aThirdFileReplacesTheSecondOnly() async {
        ...
        bAction.finish(
            sending: [.report(b)],
            .inspected(b, analyses: InspectionAnalyses(waveform: .unavailable, spectrogram: .unavailable, signalLevelMetrics: .unavailable, truePeak: .unavailable, loudness: .unavailable))
        )
        ...
        cAction.finish(.inspected(c, analyses: InspectionAnalyses(waveform: .unavailable, spectrogram: .unavailable, signalLevelMetrics: .unavailable, truePeak: .unavailable, loudness: .unavailable)))
    ...
    func theFirstFilesLateVisualisationsStillLand() async throws {
        ...
        primaryAction.finish(
            ...
            .inspected(primary, analyses: InspectionAnalyses(waveform: .available(envelope), spectrogram: .unavailable, signalLevelMetrics: .unavailable, truePeak: .unavailable, loudness: .unavailable))
        )
        await running.value
    ...
    func aNewPrimaryInspectionEndsTheComparison() async {
        ...
        fresh.finish(.inspected(newPrimary, analyses: InspectionAnalyses(waveform: .unavailable, spectrogram: .unavailable, signalLevelMetrics: .unavailable, truePeak: .unavailable, loudness: .unavailable)))
    ...
    func consecutiveComparisonsShareNoState() async {
        ...
        firstAction.finish(.inspected(b, analyses: InspectionAnalyses(waveform: .unavailable, spectrogram: .unavailable, signalLevelMetrics: .unavailable, truePeak: .unavailable, loudness: .unavailable)))
        await first.value
        ...
        secondAction.finish(
            sending: [.report(c)],
            .inspected(c, analyses: InspectionAnalyses(waveform: .unavailable, spectrogram: .unavailable, signalLevelMetrics: .unavailable, truePeak: .unavailable, loudness: .unavailable))
        )
        await second.value
    ...
    func choosingTheSameFileTwiceComparesHonestly() async {
        ...
        let comparing = Task { await flow.compare(using: second.run) }
        await second.waitUntilStarted()
        second.finish(.inspected(primary, analyses: InspectionAnalyses(waveform: .unavailable, spectrogram: .unavailable, signalLevelMetrics: .unavailable, truePeak: .unavailable, loudness: .unavailable)))
        await comparing.value
    ...
    func aComparisonNeverWarnsAboutTheFirstFile() async {
        ...
        let outcomes: [SourceInspectionOutcome] = [
            .cancelled,
            .preparationFailed,
            .inspected(globallyFailedReport(named: "b.wav"), analyses: InspectionAnalyses(waveform: .unavailable, spectrogram: .unavailable, signalLevelMetrics: .unavailable, truePeak: .unavailable, loudness: .unavailable)),
        ]
