...
struct ImportFlowComparisonTests {
    ...
    func theSecondFilesVisualisationsChangeNothing() async {
        ...
        second.finish(
            ...
            .inspected(other, analyses: InspectionAnalyses(waveform: .unavailable, spectrogram: .failed(message: "no"), signalLevelMetrics: .unavailable, truePeak: .unavailable, loudness: .unavailable, significantBandwidth: .unavailable))
        )
        await comparing.value
    ...
    func aThirdFileReplacesTheSecondOnly() async {
        ...
        bAction.finish(
            sending: [.report(b)],
            .inspected(b, analyses: InspectionAnalyses(waveform: .unavailable, spectrogram: .unavailable, signalLevelMetrics: .unavailable, truePeak: .unavailable, loudness: .unavailable, significantBandwidth: .unavailable))
        )
    ...
    func aNewPrimaryInspectionEndsTheComparison() async {
        ...
        fresh.finish(.inspected(newPrimary, analyses: InspectionAnalyses(waveform: .unavailable, spectrogram: .unavailable, signalLevelMetrics: .unavailable, truePeak: .unavailable, loudness: .unavailable, significantBandwidth: .unavailable)))
    ...
    func consecutiveComparisonsShareNoState() async {
        ...
        firstAction.finish(.inspected(b, analyses: InspectionAnalyses(waveform: .unavailable, spectrogram: .unavailable, signalLevelMetrics: .unavailable, truePeak: .unavailable, loudness: .unavailable, significantBandwidth: .unavailable)))
        await first.value
        ...
        secondAction.finish(
            sending: [.report(c)],
            .inspected(c, analyses: InspectionAnalyses(waveform: .unavailable, spectrogram: .unavailable, signalLevelMetrics: .unavailable, truePeak: .unavailable, loudness: .unavailable, significantBandwidth: .unavailable))
        )
        await second.value
    ...
    func aComparisonNeverWarnsAboutTheFirstFile() async {
        ...
        let outcomes: [SourceInspectionOutcome] = [
            .cancelled,
            .preparationFailed,
            .inspected(globallyFailedReport(named: "b.wav"), analyses: InspectionAnalyses(waveform: .unavailable, spectrogram: .unavailable, signalLevelMetrics: .unavailable, truePeak: .unavailable, loudness: .unavailable, significantBandwidth: .unavailable)),
        ]
