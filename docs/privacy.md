...
operation that needs it. It runs under the macOS
...
explicitly choose, through a native panel or by dropping them (ADR-0014) — no folder-wide or system-wide entitlement. Because one setting covers
