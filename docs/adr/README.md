...
| [0022](0022-integrated-loudness-scope-and-compliance.md) | Integrated loudness — how far compliance is claimed, and what the domain stores | Proposed (pending the normative constants and the acceptance targets) |
